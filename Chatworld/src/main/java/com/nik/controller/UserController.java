...
public void registerUser(@RequestParam("file") MultipartFile file,@RequestParam("name") String name,@RequestParam("password") String password,@RequestParam("mobile") String mobile)
{
	...
	Path path=Paths.get("D://collabprjctfinal//Chatwrldfrnt//WebContent//images//"+name+".jpg");
	if(file!=null)
	{
		try {
